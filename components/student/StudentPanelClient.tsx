...
interface StudentPanelClientProps {
  userId: string;
}

export function StudentPanelClient({ userId }: StudentPanelClientProps) {
          ...
          <div className="relative flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <h1 className="font-sans font-extrabold text-3xl sm:text-4xl text-slate-900 tracking-tight">
                Hoş geldin, <span className="text-emerald-600">{userName}</span>
              </h1>
